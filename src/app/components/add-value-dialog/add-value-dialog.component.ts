    ...
    switch (this.data.type) {
      ...
      case 'Ordered Set': {
        ...
        for (let i = 0; i < values.length; i++) {
          ...
          if (parseInt(values[i].score, 10 ) < -9007199254740992 || parseInt(values[i].score, 10 ) > 9007199254740992) {
            return this.showError(`${this.data.type} Score of row ${i + 1} must between -9007199254740992 and 9007199254740992`);
          }
